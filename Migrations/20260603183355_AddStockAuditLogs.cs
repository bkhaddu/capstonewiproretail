...
{
    /// <inheritdoc />
    public partial class AddStockAuditLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StockAuditLogId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockAuditLogs", x => x.StockAuditLogId);
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                column: "CreatedAt",
                value: new DateTime(2026, 6, 1, 21, 50, 54, 954, DateTimeKind.Local).AddTicks(2140));
        }
    }
}
